...
Modelul de inteligență artificială a fost antrenat separat de aplicație, printr-un proces reproductibil executat în Google Colab. Sunt încărcate mai întâi cele trei seturi de date publice menționate în subcapitolul 2.3, pe baza cărora este generat un \textbf{set de date sintetic} de \textbf{8\,000 de înregistrări} cu distribuție dezechilibrată, reflectând realitatea clinică: \textbf{6\,080 exemple NORMAL}, \textbf{1\,500 exemple CRITICAL} și \textbf{420 exemple ALERT}. Distribuția inegală a fost menținută intenționat, întrucât stările de alertă sunt în mod natural mai rare decât starea normală. Setul sintetic este împărțit în \textbf{6\,400 de exemple pentru antrenare} (80\%) și \textbf{1\,600 de exemple pentru testare} (20\%), cu stratificare pentru a păstra proporțiile claselor în ambele subseturi. Componentele de mișcare sunt normalizate cu un scalar Min-Max, iar modelul Random Forest este antrenat și evaluat.
...
\bibitem{preprint2024} [Autor și titlu de completat manual], Preprints.org, 2024. \url{https://www.preprints.org/frontend/manuscript/c4e7dd57faaf69c0149d1da7b6cf8b05/download_pub}.
