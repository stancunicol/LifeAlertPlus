...
\begin{tikzpicture}[node distance=0.7cm and 1.6cm,
  ...
  \node[chan, right=2.0cm of alerta, yshift=2.4cm] (push) {Push SignalR\\\scriptsize latență mică, app deschisă};
...
Avantajul acestei separări este că logica de business rămâne independentă de tehnologiile concrete: furnizorul de baze de date (PostgreSQL, SQLite pentru teste) ar putea fi înlocuit fără a modifica straturile Domain și Application. Totodată, structura facilitează testarea izolată a fiecărui strat și întreținerea pe termen lung.
...
Odată confirmată, alerta este livrată simultan prin toate canalele activate. Valorile exacte ale pragurilor de temporizare sunt:

\begin{itemize}[leftmargin=1.5em]
\item \textbf{Prag de persistență}: 1 minut — o stare anormală trebuie să se mențină cel puțin 2 măsurători consecutive înainte de a genera o notificare;
\item \textbf{Prag SMS critic}: 2 minute — canalul SMS este activat doar dacă starea critică persistă cel puțin 2 minute, evitând trimiterea SMS pentru anomalii tranzitorii;
\item \textbf{Cooldown notificări non-critice}: 10 minute — după o notificare, aceeași alertă nu se retrimite pentru același pacient timp de 10 minute.
\end{itemize}

Atâta vreme cât starea critică persistă, sistemul retrimite notificarea la fiecare 2 minute. Un mecanism separat de \textbf{cooldown} împiedică retransmiterea alertelor non-critice, evitând inundarea destinatarului. În cazul alertelor critice, sistemul include în notificare și informații despre cel mai apropiat spital față de poziția pacientului. Întregul flux, de la achiziția măsurătorii până la livrarea alertei, este ilustrat în figura~\ref{fig:flux-alerta}.
...
\begin{itemize}[leftmargin=1.5em]
\item \textbf{Inactivitate prelungită}: în ultimele 15 minute toate măsurătorile au fost etichetate \texttt{stationary}, deşi la ora curentă pacientul se mişcă în mod obişnuit cel puţin 65\% din timp (după profilul de 14 zile). Acest scenariu poate semnala o situaţie de risc (cădere nedetectată, leşin, imobilizare).
...
\begin{figure}[H]
\centering
\figplaceholder{[Spaţiu pentru figură: schema electrică a dispozitivului, prezentând ESP32-C3 Mini, multiplexorul TCA9548A, senzorii MAX30100/MPU6050/DS18B20/NEO-6M, ecranul OLED, butoanele şi LED-urile, cu pinii GPIO corespunzători şi rezistoarele de pull-up evidenţiate. Schema poate fi exportată din KiCad sau Fritzing.]}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.32\textwidth]{figuri/chatbot.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{figuri/modal-editare-profil.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{figuri/modal-wifi.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figuri/notificari.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figuri/istoric-masuratori.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figuri/profil.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figuri/setari.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figuri/despre-noi.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figuri/suport.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figuri/admin-dashboard.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figuri/admin-istoric.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figuri/admin-erori.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figuri/vizualizare-medic.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{figuri/notificare-push.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{figuri/notificare-sms.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figuri/notificare-email.png}
...
\bibitem{ds18b20} Analog Devices (Maxim Integrated), \textit{DS18B20. Programmable Resolution 1-Wire Digital Thermometer Datasheet}. \url{https://www.analog.com/media/en/technical-documentation/data-sheets/DS18B20.pdf} (accesat: 29.05.2026).
