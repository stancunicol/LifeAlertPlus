...
Modelul de inteligență artificială a fost antrenat separat de aplicație, printr-un proces reproductibil executat în Google Colab. Sunt încărcate mai întâi cele trei seturi de date publice menționate în subcapitolul 2.3, pe baza cărora este generat un \textbf{set de date sintetic} de \textbf{8\,000 de înregistrări} (câte \textasciitilde2\,667 per clasă: NORMAL, ALERT, CRITICAL), prin eșantionare cu adăugare de zgomot gaussian. Setul sintetic este împărțit în \textbf{6\,400 de exemple pentru antrenare} (80\%) și \textbf{1\,600 de exemple pentru testare} (20\%), cu stratificare pentru a păstra distribuția uniformă a claselor în ambele subseturi. Componentele de mișcare sunt normalizate cu un scalar Min-Max, iar modelul Random Forest este antrenat și evaluat.

Un exemplu reprezentativ dintr-un rând al setului de date sintetic este prezentat în tabelul~\ref{tab:data-example}.
...
Pagina de profil permite utilizatorului să modifice numele, numărul de telefon, adresa de email (cu confirmare prin email trimis la noua adresă) și parola. Dacă nicio fotografie de profil nu este asociată contului, inițialele numelui sunt afișate pe un fundal colorat în locul imaginii.
