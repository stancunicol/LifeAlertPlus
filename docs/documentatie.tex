...
Notificările push sunt livrate prin \textbf{SignalR}, printr-un hub la care clienții se conectează după autentificare. Fiecare utilizator este asociat unui grup propriu, identificat prin identificatorul său, astfel încât o notificare să poată fi direcționată exact către destinatarul vizat. Mesajele sunt afișate instantaneu în interfață sub forma unui \textit{toast} colorat în funcție de severitate (figura~\ref{fig:notificare-push}) și sunt salvate, totodată, în baza de date, pentru a putea fi consultate ulterior din pagina de notificări.
